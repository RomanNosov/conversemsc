 ...
 * 
 * При покупке больше X любых единиц товара устанавливается скидка на все товары при условии, что цена каждого товара не менее Z
 * 
 * Маска: ">numX#sumZ"
 */

class shopFlexdiscountPluginMoreSumItemLimitDiscount extends shopFlexdiscountMask
{
    ...
    public function execute($params, $order, $categories, $contact, $apply)
    {
        ...
        if (!empty($matches[0][0])) {
            ...
            foreach ($items as $item) {
                ...
                // Если цена товара ниже предела
                if ($item['price'] < $min_sum) {
                    continue;
                }
