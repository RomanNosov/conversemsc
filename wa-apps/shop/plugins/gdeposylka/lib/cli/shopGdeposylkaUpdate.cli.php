...
class shopGdeposylkaUpdateCli extends waCliController
{
    ...
    public function execute()
    {
        ...
        $this->client = new GdePosylka\Client\Client('132e2b50858558a0152b9e15b27cbbbafd1503f1b7f128e537dfcd78ec98a1334a86b94c32603ccf');
    ...
    protected function addTracks()
    {
        ...
        foreach($this->orders as $order){                    
            ...
            if (!array_key_exists($trackingNumber,$trackIndex)){        
                ...
                $fields->setTitle("m$orderNumber"); // Fields are optional
